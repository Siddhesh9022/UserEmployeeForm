...
const UserForm = () => {
  ...
  const handleSave = async e => {
    ...
    const newUser = {
      ...
      gender: form.gender,
      phone: form.phone,
      address: { pin: form.pin, district: form.district }
    }
  ...
  const disableActionButtons =
    !form.firstName.trim() || !form.lastName.trim() || duplicatePhone
            ...
            <form onSubmit={handleSave}>
              ...
              <div className="flex justify-between items-center mt-4">
                <div className="flex items-center gap-3">
                  {/* Reset button always visible but disabled when form not dirty */}
                  <button
                    type="button"
